...
\begin{table}[t]
\centering
\caption{Held-out Taxi-v3 effects at \(N=64\), mean with bootstrap \(95\%\) interval. Positive return deltas are better; negative risk deltas are better.}
\label{tab:taxi}
\begin{tabular}{lr}
\toprule
